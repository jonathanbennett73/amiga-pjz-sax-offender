...
; --- CLIP TOP ---
.cliptop:
	moveq	#VEC_LINEDRAW3_CLIPMINY,d4
	cmp.w	d4,d1		
...
.cliptop_y1:
	...
	moveq	#VEC_LINEDRAW3_CLIPMINY,d1	;set y1 to miny	
...
.clipbottom_y2:
	...
	divs	d6,d4			;/(y2-y1)
	add.w	d4,d2			;add 
	move.w	#VEC_LINEDRAW3_CLIPMAXY,d3	;set y2 to maxy
...
VEC_Object_Draw_Line_List_Vars:
	...
	dc.l	VEC_Visible_Face_Buffer			;a3, skip num faces
